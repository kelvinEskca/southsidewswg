...
class InstallerService
{
    ...
    public function databaseSetup(Request $request): bool
    {
        ...
        if (true) {
            ...
            //     'DB_HOST'     => 'localhost',
            //     'DB_PORT'     => '3306',
            //     'DB_DATABASE' => 'u556389708_southside',
            //     'DB_USERNAME' => 'u556389708_southside',
            //     'DB_PASSWORD' => 'Southside2024#',
            // ]);
            ...
            'database' => [
                ...
                'connections' => [
                    $connection => array_merge($settings, [
                        ...
                        'host'     => 'localhost',
                        'port'     => '3306',
                        'database' => 'u556389708_southside',
                        'username' => 'u556389708_southside',
                        'password' => 'Southside2024#',
                    ]),
                ],
            ],
        ]);
